...
async def slip39_show_checklist(
    ctx: wire.GenericContext, step: int, backup_type: EnumTypeBackupType
) -> None:
...
async def slip39_prompt_threshold(
    ctx: wire.GenericContext, num_of_shares: int, group_id: Optional[int] = None
) -> int:
...
async def slip39_prompt_number_of_shares(
    ctx: wire.GenericContext, group_id: Optional[int] = None
) -> int:
    count = 5
    min_count = 1
    max_count = 16
